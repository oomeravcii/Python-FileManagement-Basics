...
# file = open("plans.txt","r",encoding="utf-8") #? Opens the file. We use "utf-8" to write Turkish characters.
...
# file = open("plans.txt","w",encoding="utf-8")
...
# file = open("plans.txt","a",encoding="utf-8")
